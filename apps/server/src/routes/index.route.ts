  ...
  .openapi(
    ...
    async (c) => {
      try {
        ...
        await db.delete(menuOption)
        await db.delete(menuOptionGroup)
          ...
          .values([
            {
              ...
              categoryId: drinksId,
              currency: 'USD',
              description: 'Warm lemon flavored tea, sweetened with sugar',
              displayOrder: 1,
        ...
        // Insert menu item option groups and options
        const menuOptionGroups = await db
        ...
        await db.insert(menuOption).values([
          {
            caloriesModifier: 500,
            displayOrder: 1,
            groupId:
              menuOptionGroups.find(
                (m) =>
                  (m.name === 'Choose extra ingredients' &&
                    m.menuItemId === menuItems.find((m) => m.name === 'Chicken Curry')?.id) ||
                  ''
              )?.id || '',
            name: 'Lamb',
            priceModifier: 2,
        ...
        await db.insert(menuOption).values([
          {
            ...
            groupId:
              menuOptionGroups.find(
                (m) =>
                  (m.name === 'Choose extra ingredients' &&
                    m.menuItemId === menuItems.find((m) => m.name === 'Shrimp Curry')?.id) ||
                  ''
              )?.id || '',
            isAvailable: true,
            isDefault: false,
        ...
        await db.insert(menuOption).values([
          {
            ...
            groupId:
              menuOptionGroups.find(
                (m) =>
                  (m.name === 'Choose extra ingredients' &&
                    m.menuItemId === menuItems.find((m) => m.name === 'Lamb Curry')?.id) ||
                  ''
              )?.id || '',
            name: 'Goat',
            priceModifier: 2,
            ...
            groupId:
              menuOptionGroups.find(
                (m) =>
                  (m.name === 'Choose extra ingredients' &&
                    m.menuItemId ===
                      menuItems.find((m) => m.name === 'Chicken Coconut Curry')?.id) ||
                  ''
              )?.id || '',
            name: 'Lamb',
            priceModifier: 2,
        ...
        await db.insert(menuOption).values([
          {
            ...
            groupId:
              menuOptionGroups.find(
                (m) =>
                  (m.name === 'Choose extra ingredients' &&
                    m.menuItemId === menuItems.find((m) => m.name === 'Goat Curry')?.id) ||
                  ''
              )?.id || '',
            name: 'Lamb',
            priceModifier: 2,
